    ...
    <div class="px-5 lg:px-16 pt-28">
        ...
        <div class="px-5 lg:px-28 pt-10">
            <ol class="flex items-center w-full text-sm font-medium text-center text-gray-500 dark:text-gray-400 sm:text-base">
                ...
                <li class=" text-green-700 relative flex md:w-full items-center after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-200 after:border-1 after:hidden sm:after:inline-block after:mx-6 xl:after:mx-10 dark:after:border-gray-700 ">
        ...
        <div class="relative rounded-md overflow-x-auto max-w-7xl mx-auto pt-8 shadow-lg my-3 ">
            <h3 class="text-xl font-bold text-maincolor px-4 py-2 "> جزئیات سفارش</h3>
            ...
            <div class="flex px-10 py-5 font-bold gap-4 justify-around bg-maincolor/10 my-5 text-maincolor"><p>  وضعیت سفارش  :</p> <span>{{ cart.is_sent ? 'ارسال شد' : 'در حال بررسی' }}</span></div>

            <!-- price -->
            <div class="px-5 py-8 space-y-2">
                <div class="flex gap-4 justify-between text-maincolor"><p> نام گیرنده  :</p> <span>{{ cart.address.name }}</span></div>
                ...
                <div class="flex gap-4 justify-between text-maincolor"><p> تاریخ سفارش :</p> <span>{{ cart.get_predicted_date }}</span></div>
                <div class="flex gap-4 justify-between text-maincolor"><p> کد سفارش :</p> <span> {{ cart.id }} </span></div>
            </div>
        </div>
    </div>
</template>
